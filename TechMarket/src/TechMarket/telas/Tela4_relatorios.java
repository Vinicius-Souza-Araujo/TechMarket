...
public class Tela4_relatorios extends JFrame {
	...
	public Tela4_relatorios() {
		...
		lblNewLabel_1.setBounds(590, 32, 214, 38);
		...
		PanelBotao.setBounds(110, 88, 1155, 38);
		...
		tblSintetico.setModel(new DefaultTableModel(
			new Object[][] {
				{1, "Vinicius", 150,"02-02-2022"},
				{ 2, "Rayane", 250, "03-02-2022"},
				{3, "Lucas", 500, "04-02-2022"},
				{4, "Pamera", 400, "05-02-2022"},
			},
			new String[] {
		...
		btnAnalitico.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(indiceLinha >= 0){
					String cliente = tblSintetico.getModel().getValueAt(indiceLinha, 0).toString();
					JOptionPane.showMessageDialog(btnAnalitico, "ID carrinho "+cliente+" coletado!");
			       }else{
